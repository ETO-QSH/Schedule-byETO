...
class Get_ROLEID_and_sessionID():
    ...
    def main(self):
        ...
        WebDriverWait(self.browser, 20, 1).until(EC.presence_of_element_located(
            (By.XPATH, "/html/body/div[1]/div/div/div[2]/div[2]/div[2]/div/div[2]/iframe")))
        ...
        WebDriverWait(self.browser, 60, 1).until(
            EC.presence_of_element_located((By.XPATH, "/html/body/main/article/h2/a")))
        self.browser.find_element(By.XPATH, "/html/body/main/article/h2/a").click()
        WebDriverWait(self.browser, 20, 1).until(
            EC.presence_of_element_located((By.XPATH, "/html/body/div[7]/div[2]/div[1]/div/div[2]/div")))
        self.browser.find_element(By.XPATH, "/html/body/div[7]/div[2]/div[1]/div/div[2]/div").click()
        WebDriverWait(self.browser, 20, 1).until(
            EC.element_to_be_clickable((By.XPATH, "/html/body/div[9]/div/div/div/div[2]/div/div[2]")))
        self.browser.find_element(By.XPATH, "/html/body/div[9]/div/div/div/div[2]/div/div[2]").click()
        WebDriverWait(self.browser, 20, 1).until(
            EC.element_to_be_clickable((By.XPATH, "/html/body/div[7]/div[2]/div[2]/button[2]")))
        self.browser.find_element(By.XPATH, "/html/body/div[7]/div[2]/div[2]/button[2]").click()
        WebDriverWait(self.browser, 20, 1).until(
            EC.element_to_be_clickable((By.XPATH, "/html/body/main/article/section/div[2]/a[1]")))
        ...
        match = re.search(r"FR\.SessionMgr\.register\('(\d+)', contentPane\);",
