...
public class GetConverter {
    ...
    public static JSONObject convertTimetable(String jsonData, int minutes) throws JSONException {
         ...
         return formatTapJson(classDict, minutes);
    }
    ...
    private static JSONObject formatTapJson(List<Map<String, Object>> data, int minutes) throws JSONException {
        JSONObject root = new JSONObject();
        JSONArray entries = new JSONArray();
        LocalDate baseDate = LocalDate.of(2025, 2, 23);
    ...
    public static JSONObject handleResult(String jsonData, int minutes) {
        try {
            return GetConverter.convertTimetable(jsonData, minutes);
        } catch (Exception e) {
            return null;
        }
    }
